...
post("/", function(req, res){
    ...
    //指定图片缓存路径，要和保存路径在同一个磁盘下，否则会报错Error: EXDEV: cross-device link not permitted, rename 'XXX'->'XXX'
    form.uploadDir = uploadfolderpath + "/temp/"
        ...
        for (item in files) {
            ...
            fs.rename(tempfilepath, filenewpath, function (err) {
                ...
                if (err) {
                    ...
                    // 拼接图片url地址
                    result ='/images/' + uploadfoldername + '/' + filename;
                }
